...
export function useDistribution(args: UseDistributionArgs): UseDistributionResult {
  ...
  useEffect(() => {
    ...
    args.distributionInputs.startingBalanceOverride,
    ...
    args.distributionInputs.rothPortfolioPct,
    args.distributionInputs.wholeLifeCashValueAtRetirement,
    args.distributionInputs.wholeLifeCashValueGrowthRatePct,
    args.distributionInputs.wholeLifeLoanInterestRatePct,
